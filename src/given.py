...
Updated by Thomas Johansson 2015-12-03 GetBearing
"""
...
def getHeading():
    """Returns the XY Orientation as a heading unit vector.
       The heading is the angle between the world x-axis and the robots
       axis. Bearing, on the other hand, is the angle to another
       object relative to the robots axis"""
